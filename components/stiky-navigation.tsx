      ...
      <div className="flex items-center justify-between px-2">
        {links.map((link) => (
          <LinkCard
            ...
            className={
              link.Icon == QrCode
                ? "relative bg-transparent  -mt-3 z-20  before:-z-10 before:left-1/2 before:transform before:-translate-x-1/2 before:bg-[var(--primary-text)] before:size-full before:rounded-full before:absolute "
